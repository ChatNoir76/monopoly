...
/**
 * Fen�tre � afficher lorqu'un joueur est en prison. Il a alors le choix : payer pour en sortir, ou rester et jouer sa lib�ration aux d�s.
...
public class FenetreSortirPrison {
	...
	/**
	 * Unique constructeur de la classe {@link FenetreSortirPrison}, prenant en param�tre la {@link FenetrePrincipale} fp.
	...
	private void initRoot() {
		...
		Image i_prison = new Image(getClass().getResourceAsStream("/images/prison.jpg"));
