...
public class FenetreAcheterTerrain {
	...
	/**
	 * Unique constructeur de la classe {@link FenetreAcheterTerrain}, prenant en param�tre la {@link FenetrePrincipale} fp.
	...
	private void initRoot() {
		...
		case "Gare Montparnasse": i_terrain = new Image(getClass().getResourceAsStream("/images/gare.jpg")); break;
		case "Gare de Lyon": i_terrain = new Image(getClass().getResourceAsStream("/images/gare.jpg")); break;
		case "Gare du Nord": i_terrain = new Image(getClass().getResourceAsStream("/images/gare.jpg")); break;
		case "Gare Saint-Lazare": i_terrain = new Image(getClass().getResourceAsStream("/images/gare.jpg")); break;
		case "Compagnie des eaux": i_terrain = new Image(getClass().getResourceAsStream("/images/eau.jpg")); break;
		case "Compagnie d'�lectricit�": i_terrain = new Image(getClass().getResourceAsStream("/images/elec.jpg")); break;
		default: {
			String couleur = fp.getPartie().getPM().getCaseActive().getCouleur();
			i_terrain = new Image(getClass().getResourceAsStream("/images/m_"+couleur+".jpg"));
		}; break;
		}
