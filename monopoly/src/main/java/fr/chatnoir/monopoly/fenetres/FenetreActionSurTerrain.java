...
public class FenetreActionSurTerrain {
	...
	private void initRoot() {
		...
		switch(position) {
		case 5: i_terrain = new Image(getClass().getResourceAsStream("/images/gare.jpg")); break;
		case 15: i_terrain = new Image(getClass().getResourceAsStream("/images/gare.jpg")); break;
		case 25: i_terrain = new Image(getClass().getResourceAsStream("/images/gare.jpg")); break;
		case 35: i_terrain = new Image(getClass().getResourceAsStream("/images/gare.jpg")); break;
		case 28: i_terrain = new Image(getClass().getResourceAsStream("/images/eau.jpg")); break;
		case 12: i_terrain = new Image(getClass().getResourceAsStream("/images/elec.jpg")); break;
		default: {
