...
public class CaseTerrain extends Case {
	...
	public void ajouterMaison(FenetrePrincipale fp){
		...
		if(this.nbMaison <=4 ){
			...
			System.out.println(" > " + proprietaire.getNom() + " a pos� un h�tel sur "+getNom()+" et ne peut plus poser de b�timents!");
			if(fp!=null) fp.afficherMessage(" > " + proprietaire.getNom() + " a pos� un h�tel sur "+getNom()+" et ne peut plus poser de b�timents!");
		}
	}
	...
	public boolean getPeutMettreMaison() {
		if(proprietaire.getListeCouleur().contains(this.getCouleur())){
			...
			if(getNbMaison() == 5) {
				this.peutMettreMaison = false;
				System.out.println("Le quota de b�timents est atteint !");
			}
		}
		else
			this.peutMettreMaison = false;
