...
public class CaseDepart extends Case {
	...
	public void actionCase(JoueurMonopoly joueur, PlateauMonopoly plateau, FenetrePrincipale fp) {
		...
		es.println(" > " + joueur.getNom() + " s'arr�te sur la case d�part: il re�oit 2000� suppl�mentaire !");
		if(fp!=null) fp.afficherMessage(joueur.getNom() + " s'arr�te sur la case d�part et re�oit 4000� !");
	}
